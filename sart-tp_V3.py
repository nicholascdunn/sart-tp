...
for block in blockFiles:
    ...
    for trial in trials:
        ...
        if trialType == "Target" or "Non-target" or "Probe 1":
            stimulus = trial['stimulus']
        if trialType == "Probe 2" and previousResp == 1:
            stimulus = trial['stimulus']
        if trialType == "Probe 2" and previousResp == 0:
            stimulus = 'Where was your mind while off-task?'
